//获取所有需要操作的元素
var show = document.getElementById("show"); //父级元素
var  showul = document.getElementById("shownav"); //ul 
var divs = show.getElementsByTagName("div"); //获取父级里面需要显示的div元素
var moveli = showul.children; //获取ul下面所有需要移入的li元素
var show_sanjiao = showul.getElementsByClassName("show_border"); //这是每个li元素下面的border元素
var img = showul.getElementsByTagName("img"); //获取图片元素
